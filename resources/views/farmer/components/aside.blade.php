            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('farmer/crops') ? 'active' : '' }}" aria-current="page"
                        href="/farmer/crops">
                        <i class="icon" data-bs-toggle="tooltip" title="Crops Report" data-bs-placement="right">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('farmer/water') ? 'active' : '' }}" aria-current="page"
                        href="/farmer/water">
                        <i class="icon" data-bs-toggle="tooltip" title="Irrigation Report" data-bs-placement="right">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('farmer/energy') ? 'active' : '' }}" aria-current="page"
                        href="/farmer/energy">
                        <i class="icon" data-bs-toggle="Energy Usage" title="Energy Usage" data-bs-placement="right">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
